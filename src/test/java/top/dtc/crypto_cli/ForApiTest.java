...
public class ForApiTest {
    ...
    public void go() throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        assertEquals("KwmcWvs3eKEcnfeHoJZ8Hw2MuuU6CDCFWzT2H5HGffaHFXifdhFf", Base58.encode(BIP.wif(BIP0032.toPrivateKey(xprv_196_761273_0_0))));
        ...
        assertEquals("L4vDVKWMW83rdfjxxSkCf1FDv4CnXgKziHKzgEXrXkDeRSEV1a8E", Base58.encode(BIP.wif(BIP0032.toPrivateKey(xprv_196_761273_0_516717))));
    }
